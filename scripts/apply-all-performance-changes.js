...
// ========== 3. MATERIAL SYMBOLS: subsetado ==========
{
  ...
  const to = '<!-- Material Symbols SUBSETADO: solo íconos usados (~15KB vs ~1MB completo) -->\n    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,0&icon_names=architecture,arrow_downward,arrow_forward,article,bar_chart,calculate,call,cancel,chat,check,check_circle,chevron_right,close,construction,cottage,dark_mode,email,engineering,expand_more,explore,foundation,grid_on,grid_view,group,handshake,holiday_village,home,home_repair_service,keyboard_arrow_right,landscape,layers,light_mode,location_on,mail,menu,phone,pool,precision_manufacturing,request_quote,roofing,schedule,search,shield,star,support_agent,tune,verified,villa,visibility&display=swap" rel="preload" as="style" onload="this.onload=null;this.rel=\'stylesheet\'"/>\n    <noscript><link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,0&icon_names=architecture,arrow_downward,arrow_forward,article,bar_chart,calculate,call,cancel,chat,check,check_circle,chevron_right,close,construction,cottage,dark_mode,email,engineering,expand_more,explore,foundation,grid_on,grid_view,group,handshake,holiday_village,home,home_repair_service,keyboard_arrow_right,landscape,layers,light_mode,location_on,mail,menu,phone,pool,precision_manufacturing,request_quote,roofing,schedule,search,shield,star,support_agent,tune,verified,villa,visibility&display=swap" rel="stylesheet"/></noscript>';

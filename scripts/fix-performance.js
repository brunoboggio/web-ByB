...
const MATERIAL_SYMBOLS_SUBSETTED =
  ...
  'arrow_drop_down,arrow_forward,aspect_ratio,assignment_turned_in,bathtub,bed,bolt,border_color,' +
  ...
  'cleaning_services,close,compare_arrows,construction,cottage,countertops,dashboard_customize,' +
  'deck,delete_sweep,description,design_services,diamond,domain,done,door_open,eco,edit_calendar,' +
  ...
  'outdoor_grill,palette,payments,photo_size_select_large,photo_size_select_small,plumbing,pool,' +
  'precision_manufacturing,privacy_tip,quiz,restart_alt,restore,roofing,rounded_corner,savings,' +
  ...
  'water_drop_off,water_lux,wb_sunny,window' +
  '&display=swap';

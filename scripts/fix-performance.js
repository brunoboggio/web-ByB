...
// ─────────────────────────────────────────────────────────────────────────────
// Complete union of ALL icon names used across every page of the site
// (generated by scanning all HTML files for class="material-symbols-outlined">icon_name<)
const MATERIAL_SYMBOLS_SUBSETTED =
  'https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200' +
  '&icon_names=ac_unit,account_balance_wallet,add,air,analytics,architecture,arrow_back,arrow_downward,' +
  'arrow_drop_down,arrow_forward,article,aspect_ratio,assignment_turned_in,bathtub,bed,bolt,border_color,' +
  'border_outer,broken_image,build,cabin,calculate,calendar_month,calendar_today,call,camera_alt,' +
  'chair,change_history,chat,chat_bubble,check,check_circle,chevron_left,chevron_right,' +
  'cleaning_services,close,compare_arrows,construction,cottage,countertops,dark_mode,dashboard_customize,' +
  'deck,delete_sweep,description,design_services,diamond,diversity_3,domain,done,door_open,eco,edit_calendar,' +
  'energy_savings_leaf,engineering,expand_more,explore,face_nod,fact_check,filter_drama,' +
  'folder_open,forest,format_paint,foundation,garage,gavel,graphic_eq,grid_on,grid_view,' +
  'holiday_village,home,home_repair_service,home_work,house,humidity_percentage,info,insights,' +
  'key,kitchen,landscape,layers,layers_clear,light_mode,line_style,list_alt,local_fire_department,' +
  'location_on,lock,mail,menu,monetization_on,nature_people,nest_thermostat_sensor,opacity_off,' +
  'outdoor_grill,palette,payments,phone,photo_size_select_large,photo_size_select_small,plumbing,pool,' +
  'precision_manufacturing,privacy_tip,quiz,request_quote,restart_alt,restore,roofing,rounded_corner,savings,' +
  'schedule,search,security,send,shield,shield_with_house,solar_power,space_bar,space_dashboard,' +
  'speed,splitscreen,star,store,straighten,style,support_agent,swap_horiz,task_alt,thermostat,' +
  'thumb_up,thumbs_up_down,timer,trending_down,trending_up,tune,update,verified,verified_user,' +
  'view_in_ar,view_quilt,view_stream,villa,visibility,wall,warning,water_damage,water_drop,' +
  'water_drop_off,water_lux,wb_sunny,whatsapp,window' +
  '&display=swap';
